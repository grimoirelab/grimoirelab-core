...
from grimoirelab.core.scheduler.backends.gitlab import GitLab

GITLAB_API_URL = "https://gitlab.com/api/v4"

GITLAB_USER_NAME = "user_example"
GITLAB_USER_ID = 123456
GITLAB_USER_URL = f"{GITLAB_API_URL}/users?username={GITLAB_USER_NAME}"
GITLAB_USER_REPOS_URL = f"{GITLAB_API_URL}/users/{GITLAB_USER_ID}/projects"

GITLAB_GROUP_NAME = "group_example"
GITLAB_GROUP_ID = 654321
GITLAB_GROUP_URL = f"{GITLAB_API_URL}/groups/{GITLAB_GROUP_NAME}"
GITLAB_GROUP_REPOS_URL = f"{GITLAB_API_URL}/groups/{GITLAB_GROUP_ID}/projects"
...
class TestGitLabOwnerRepos(unittest.TestCase):
    ...
    def test_fetch_user_repositories(self):
        ...
        self.assertEqual(repo['has_pull_requests'], False)
        ...
        self.assertEqual(repo['has_pull_requests'], True)
        self.assertEqual(repo['archived'], False)
    ...
    def test_fetch_group_repositories(self):
        ...
        repo = repositories[2]
        self.assertEqual(repo['url'], 'https://gitlab.com/group_example/subgroup/project-3')
        self.assertEqual(repo['fork'], False)
        self.assertEqual(repo['has_issues'], True)
        self.assertEqual(repo['has_pull_requests'], True)
        self.assertEqual(repo['archived'], False)
