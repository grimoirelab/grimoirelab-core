...
urlpatterns = [
    ...
    re_path(r'^github_owner', views.github_owner_repos),
    re_path(r'^gitlab_owner', views.gitlab_owner_repos),
    re_path(r'^owner_job/(?P<job_id>[a-zA-Z0-9_.-]+)/$', views.show_owner_job),
]
