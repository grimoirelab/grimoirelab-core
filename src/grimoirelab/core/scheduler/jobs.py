...
from .backends.github import github_owner_repositories
from .backends.gitlab import GitLab
...
@django_rq.job
def fetch_github_owner_repos(owner, api_token=None):
    ...
    try:
        for repository in github_owner_repositories(owner, api_token=api_token):
    ...
    logger.info(
        ...
        f"{len(repositories)} repositories fetched"
    )
...
@django_rq.job
def fetch_gitlab_owner_repos(owner, api_token=None):
